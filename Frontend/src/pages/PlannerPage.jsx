        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {activeTab === 'plan' && studyPlan && (
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div className="bg-blue-900/50 backdrop-blur-md rounded-xl p-6 border border-blue-700/50">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {studyPlan.subjects.map((subject, index) => (
                    <div key={index} className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
                      ...
                      <span className="inline-flex px-2 py-1 rounded-full text-xs font-medium bg-blue-900/50 text-blue-300 border border-blue-500/50">
                  ...
                  {studyPlan.weeklySchedule.map((week, index) => (
                    <div key={index} className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="bg-blue-900/50 text-blue-300 px-3 py-1 rounded-full text-sm font-medium border border-blue-500/50">
                          Focus: {week.focus}
                        </span>
                      </div>
          ...
          {activeTab === 'timer' && (
            <div className="max-w-2xl mx-auto">
              <div className="bg-gray-900/50 backdrop-blur-md rounded-xl shadow-2xl border border-gray-800 p-8 text-center">
                ...
                <div className="mb-8">
                  <div className={`text-6xl font-bold mb-4 ${
                    studyTimer.isBreak ? 'text-white' : 'text-blue-400'
                  }`}>
                ...
                <div className="flex justify-center space-x-4 mb-8">
                  <button
                    ...
                    className="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200 flex items-center"
                  >
                  ...
                  <button
                    onClick={resetTimer}
                    className="bg-gray-800 text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-700 border border-gray-700 hover:border-gray-600 transition-all duration-200 flex items-center"
                  >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                    ...
                    <p className="text-white">5 minutes rest & refresh</p>
                  </div>
                </div>
              </div>
            </div>
